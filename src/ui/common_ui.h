...
void process_name_scroll(const char *name, char *output, int max_width, bool is_same_name_as_last_time, bool strip_track_numbers);
void reset_name_scroll(void);
void reset_color(void);
void process_name(const char *name, char *output, int max_width, bool strip_track_numbers, bool strip_suffix);
